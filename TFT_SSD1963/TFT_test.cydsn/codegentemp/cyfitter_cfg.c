...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000220u)

/* UDB_0_0_0_CONFIG Address: CYDEV_UCFG_B1_P5_U0_BASE Size (bytes): 128 */
#define BS_UDB_0_0_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000228u)
...
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x480002C0u)
...
void cyfitter_cfg(void)
{
	...
	ClockSetup();
	/* Set Flash Cycles based on newly configured 63.00MHz Bus Clock. */
